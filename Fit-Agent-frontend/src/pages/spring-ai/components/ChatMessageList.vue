<template>
    ...
    >
        ...
        <!-- Step Execution Card -->
        <step-execution-card
            v-if="agentSteps && agentSteps.length > 0"
            :steps="agentSteps"
        />
        ...
        <div
            class="message bot message-thinking"
...
export default {
    ...
    methods: {
        ...
        shouldShowDateSeparator(index) {
            ...
            var previousDateKey = this.getDateKey(
